...
*/
  u2_noun                                                         //  transfer
  j2_mcx(Pt6, ut, finq)(u2_wire wir_r, 
                        u2_noun van,                              //  retain
                        u2_noun sut,                              //  retain
                        u2_noun dep,                              //  retain
                        u2_noun way,                              //  retain
...
*/
  ...
  u2_noun                                                         //  transfer
  j2_mc(Pt6, ut, finq)(u2_wire wir_r, 
                       u2_noun cor)                               //  retain
  {
         ...
         (u2_none == (sut = u2_frag(u2_cv_sam, van))) )
    {
      ...
      return j2_mcx(Pt6, ut, finq)(wir_r, van, sut, dep, way, cog);
    }
  }

  u2_weak                                                         //  transfer
  j2_mci(Pt6, ut, finq)(u2_wire wir_r,
                        u2_noun van,                              //  retain
                        u2_noun sut,                              //  retain 
                        u2_noun dep,                              //  retain
                        u2_noun way,                              //  retain
                        u2_noun cog)                              //  retain
  {
    u2_weak hoc = u2_ds_look(wir_r, van, "finq");

    if ( u2_none == hoc ) {
      c3_assert(!"register finq");
      return u2_none;
    } else {
      ...
      if ( (u2_none == j2_mcj(Pt6, ut, finq)[0].xip) ) {
        u2_noun xip = u2_ds_find(wir_r, cor);
     
        c3_assert(u2_none != xip);
        j2_mcj(Pt6, ut, finq)[0].xip = xip;
      }
  ...
  u2_noun                                                         //  transfer
  j2_mcy(Pt6, ut, finq)(u2_wire wir_r,
                        u2_noun van,                              //  retain
                        u2_noun sut,                              //  retain
                        u2_noun dep,
                        u2_noun way,                              //  retain
                        u2_noun cog)                              //  retain
  {
    u2_ho_jet *jet_j = &j2_mcj(Pt6, ut, finq)[0];
    ...
    if ( (jet_j->sat_s & u2_jet_live) && !(jet_j->sat_s & u2_jet_test) ) {
      if ( !(jet_j->sat_s & u2_jet_memo) ) {
        ...
        if ( u2_none != pro ) {
          ...
          pro = j2_mcx(Pt6, ut, finq)(wir_r, van, sut, dep, way, cog);
      ...
      cor = j2_mci(Pt6, ut, finq)(wir_r, van, sut, dep, way, cog);
      fol = u2_h(cor);
  ...
  u2_weak
  j2_mck(Pt6, ut, finq)(u2_wire wir_r,
                        u2_noun cor)
  {
    u2_noun sut, dep, way, cog, van;
